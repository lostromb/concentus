...
{
    internal static class NativeOpusShim
    {
        private const string LIBRARY_NAME = "opus";

        public static bool Initialize()
        {
            NativeLibraryStatus status = NativePlatformUtils.PrepareNativeLibrary(LIBRARY_NAME);
        ...
        internal const int OPUS_GET_FORCE_MODE_REQUEST = 11003;
