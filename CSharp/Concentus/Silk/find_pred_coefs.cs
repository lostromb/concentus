    ...
    public static class find_pred_coefs
    {
        ...
        )
        {
            ...
            if (psEnc.indices.signalType == SilkConstants.TYPE_VOICED)
            {
                ...
                quant_LTP_gains.silk_quant_LTP_gains(psEncCtrl.LTPCoef_Q14, psEnc.indices.LTPIndex, boxed_periodicity,
                ...
                /* Create LTP residual */
                LTP_analysis_filter.silk_LTP_analysis_filter_FIX(LPC_in_pre, x.Point(0 - psEnc.predictLPCOrder), psEncCtrl.LTPCoef_Q14,
                ...
                psEncCtrl.LTPCoef_Q14.MemSet(0, psEnc.nb_subfr * SilkConstants.LTP_ORDER);
            ...
            find_LPC.silk_find_LPC_FIX(psEnc, NLSF_Q15, LPC_in_pre, minInvGain_Q30);
            ...
            NLSF_Q15.MemCopyTo(psEnc.prev_NLSFq_Q15, SilkConstants.MAX_LPC_ORDER);
