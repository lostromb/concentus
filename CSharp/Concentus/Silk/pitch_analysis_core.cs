        ...
        )
        {
            ...
            *********************************************************************************/
            ...
            for (k = 0; k < length_d_srch; k++)
            {
                ...
                Inlines.OpusAssert(nb_subfr * Inlines.SILK_FIX_CONST(SilkConstants.PE_SHORTLAG_BIAS, 13) == Inlines.silk_SAT16(nb_subfr * Inlines.SILK_FIX_CONST(SilkConstants.PE_SHORTLAG_BIAS, 13)));
                ...
                Inlines.OpusAssert(nb_subfr * Inlines.SILK_FIX_CONST(SilkConstants.PE_PREVLAG_BIAS, 13) == Inlines.silk_SAT16(nb_subfr * Inlines.SILK_FIX_CONST(SilkConstants.PE_PREVLAG_BIAS, 13)));
                if (prevLag > 0)
                {
