...
{
    public static class HP_variable_cutoff
    {
        /// <summary>
        ...
        public static void silk_HP_variable_cutoff(Pointer<silk_encoder_state> state_Fxx)
        {
            ...
            if (psEncC1.prevSignalType == SilkConstants.TYPE_VOICED)
            {
                ...
                pitch_freq_log_Q7 = Inlines.silk_SMLAWB(pitch_freq_log_Q7, Inlines.silk_SMULWB(Inlines.silk_LSHIFT(-quality_Q15, 2), quality_Q15),
                      pitch_freq_log_Q7 - (Inlines.silk_lin2log(Inlines.SILK_FIX_CONST(TuningParameters.VARIABLE_HP_MIN_CUTOFF_HZ, 16)) - (16 << 7)));
                ...
                delta_freq_Q7 = Inlines.silk_LIMIT_32(
                    delta_freq_Q7,
                    0 - Inlines.SILK_FIX_CONST(TuningParameters.VARIABLE_HP_MAX_DELTA_FREQ, 7),
                    Inlines.SILK_FIX_CONST(TuningParameters.VARIABLE_HP_MAX_DELTA_FREQ, 7));

                /* update smoother */
                psEncC1.variable_HP_smth1_Q15 = Inlines.silk_SMLAWB(psEncC1.variable_HP_smth1_Q15,
                      Inlines.silk_SMULBB(psEncC1.speech_activity_Q8, delta_freq_Q7), Inlines.SILK_FIX_CONST(TuningParameters.VARIABLE_HP_SMTH_COEF1, 16));
