...
namespace Concentus.Common
{
    public static class Inlines
    {
        ...
        {
            //Debug.Assert(x > 0, "celt_ilog2() only defined for strictly positive numbers");
            if (x <= 0)
        ...
        public static int celt_rcp(int x)
        {
            ...
            int n;
            int r;
            Debug.Assert(x > 0, "celt_rcp() only defined for positive values");
            i = celt_ilog2(x);
        ...
        */
        ...
        {
            uint ret = a32 * b32;
            Debug.Assert((ulong)ret == (ulong)a32 * (ulong)b32);
            return ret;
        }
        ...
        public static int silk_MLA(int a32, int b32, int c32)
        {
            ...
            Debug.Assert((long)ret == (long)a32 + (long)b32 * (long)c32);
            return ret;
        }
        ...
        public static long silk_ADD64(long a, long b)
        {
            ...
            Debug.Assert(ret == silk_ADD_SAT64(a, b));
            return ret;
        }
        ...
        {
            short ret = (short)(a - b);
            Debug.Assert(ret == silk_SUB_SAT16(a, b));
            return ret;
        }
        ...
        {
            int ret = a - b;
            Debug.Assert(ret == silk_SUB_SAT32(a, b));
            return ret;
        }
        ...
        {
            long ret = a - b;
            Debug.Assert(ret == silk_SUB_SAT64(a, b));
            return ret;
        }
        ...
        public static short silk_ADD_SAT16(short a16, short b16)
        {
            ...
            Debug.Assert(res == silk_SAT16((int)a16 + (int)b16));
            return res;
        }
        ...
        public static int silk_ADD_SAT32(int a32, int b32)
        {
            ...
            Debug.Assert(res == silk_SAT32((long)a32 + (long)b32));
            return res;
        }
    ...
    )
        {
            ...
            for (i = 0; i < dataSize; i++)
            {
                ...
                data_out[i] = (short)silk_CHECK_FIT16(tmp32);
            }
        }
        ...
        )
        {
            ...
            for (i = 0; i < dataSize; i++)
            {
                data1[i] = (int)silk_CHECK_FIT32(silk_RSHIFT64(silk_SMULL(data1[i], gain_Q26), 8));    /* OUTPUT: Q18 */
            }
        }
