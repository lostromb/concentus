...
func (s *SilkNSQState) silk_noise_shape_quantizer(
	...
	for i = 0; i < length; i++ {
		/* Generate dither */
		s.rand_seed = inlines.Silk_RAND(s.rand_seed)

		/* Short-term prediction */
		inlines.OpusAssert(predictLPCOrder == 10 || predictLPCOrder == 16)
		/* Avoids introducing a bias because Inlines.inlines.Silk_SMLAWB() always rounds to -inf */
		LPC_pred_Q10 = inlines.Silk_RSHIFT(predictLPCOrder, 1)
		LPC_pred_Q10 = inlines.Silk_SMLAWB(LPC_pred_Q10, s.sLPC_Q14[psLPC_Q14-0], int(a_Q12[0]))
		LPC_pred_Q10 = inlines.Silk_SMLAWB(LPC_pred_Q10, s.sLPC_Q14[psLPC_Q14-1], int(a_Q12[1]))
		LPC_pred_Q10 = inlines.Silk_SMLAWB(LPC_pred_Q10, s.sLPC_Q14[psLPC_Q14-2], int(a_Q12[2]))
		LPC_pred_Q10 = inlines.Silk_SMLAWB(LPC_pred_Q10, s.sLPC_Q14[psLPC_Q14-3], int(a_Q12[3]))
		LPC_pred_Q10 = inlines.Silk_SMLAWB(LPC_pred_Q10, s.sLPC_Q14[psLPC_Q14-4], int(a_Q12[4]))
		LPC_pred_Q10 = inlines.Silk_SMLAWB(LPC_pred_Q10, s.sLPC_Q14[psLPC_Q14-5], int(a_Q12[5]))
		LPC_pred_Q10 = inlines.Silk_SMLAWB(LPC_pred_Q10, s.sLPC_Q14[psLPC_Q14-6], int(a_Q12[6]))
		LPC_pred_Q10 = inlines.Silk_SMLAWB(LPC_pred_Q10, s.sLPC_Q14[psLPC_Q14-7], int(a_Q12[7]))
		LPC_pred_Q10 = inlines.Silk_SMLAWB(LPC_pred_Q10, s.sLPC_Q14[psLPC_Q14-8], int(a_Q12[8]))
		LPC_pred_Q10 = inlines.Silk_SMLAWB(LPC_pred_Q10, s.sLPC_Q14[psLPC_Q14-9], int(a_Q12[9]))
		if predictLPCOrder == 16 {
			LPC_pred_Q10 = inlines.Silk_SMLAWB(LPC_pred_Q10, s.sLPC_Q14[psLPC_Q14-10], int(a_Q12[10]))
			LPC_pred_Q10 = inlines.Silk_SMLAWB(LPC_pred_Q10, s.sLPC_Q14[psLPC_Q14-11], int(a_Q12[11]))
			LPC_pred_Q10 = inlines.Silk_SMLAWB(LPC_pred_Q10, s.sLPC_Q14[psLPC_Q14-12], int(a_Q12[12]))
			LPC_pred_Q10 = inlines.Silk_SMLAWB(LPC_pred_Q10, s.sLPC_Q14[psLPC_Q14-13], int(a_Q12[13]))
			LPC_pred_Q10 = inlines.Silk_SMLAWB(LPC_pred_Q10, s.sLPC_Q14[psLPC_Q14-14], int(a_Q12[14]))
			LPC_pred_Q10 = inlines.Silk_SMLAWB(LPC_pred_Q10, s.sLPC_Q14[psLPC_Q14-15], int(a_Q12[15]))
		}
		...
		n_AR_Q12 = inlines.Silk_SMLAWB(n_AR_Q12, tmp2, int(AR_shp_Q13[AR_shp_Q13_ptr]))
		for j = 2; j < shapingLPCOrder; j += 2 {
			tmp2 = s.sAR2_Q14[j-1]
			s.sAR2_Q14[j-1] = tmp1
			n_AR_Q12 = inlines.Silk_SMLAWB(n_AR_Q12, tmp1, int(AR_shp_Q13[AR_shp_Q13_ptr+j-1]))
			tmp1 = s.sAR2_Q14[j+0]
			s.sAR2_Q14[j+0] = tmp2
			n_AR_Q12 = inlines.Silk_SMLAWB(n_AR_Q12, tmp2, int(AR_shp_Q13[AR_shp_Q13_ptr+j]))
		}
		s.sAR2_Q14[shapingLPCOrder-1] = tmp1
		n_AR_Q12 = inlines.Silk_SMLAWB(n_AR_Q12, tmp1, int(AR_shp_Q13[AR_shp_Q13_ptr+shapingLPCOrder-1]))

		n_AR_Q12 = inlines.Silk_LSHIFT32(n_AR_Q12, 1)
		/* Q11 . Q12 */
		n_AR_Q12 = inlines.Silk_SMLAWB(n_AR_Q12, s.sLF_AR_shp_Q14, Tilt_Q14)

		n_LF_Q12 = inlines.Silk_SMULWB(s.sLTP_shp_Q14[s.sLTP_shp_buf_idx-1], LF_shp_Q14)
		n_LF_Q12 = inlines.Silk_SMLAWT(n_LF_Q12, s.sLF_AR_shp_Q14, LF_shp_Q14)
		...
		if lag > 0 {
			...
			n_LTP_Q13 = inlines.Silk_SMULWB(inlines.Silk_ADD32(s.sLTP_shp_Q14[shp_lag_ptr], s.sLTP_shp_Q14[shp_lag_ptr-2]), HarmShapeFIRPacked_Q14)
			n_LTP_Q13 = inlines.Silk_SMLAWT(n_LTP_Q13, s.sLTP_shp_Q14[shp_lag_ptr-1], HarmShapeFIRPacked_Q14)
		...
		pulses[pulses_ptr+i] = int8(inlines.Silk_RSHIFT_ROUND(q1_Q10, 10))
		...
		xq[xq_ptr+i] = int16(inlines.Silk_SAT16(inlines.Silk_RSHIFT_ROUND(inlines.Silk_SMULWW(xq_Q14, Gain_Q10), 8)))
		...
		s.sLTP_shp_Q14[s.sLTP_shp_buf_idx] = inlines.Silk_SUB_LSHIFT32(sLF_AR_shp_Q14, n_LF_Q12, 2)
		sLTP_Q15[s.sLTP_buf_idx] = inlines.Silk_LSHIFT(LPC_exc_Q14, 1)
		s.sLTP_shp_buf_idx++
		s.sLTP_buf_idx++

		/* Make dither dependent on quantized signal */
		s.rand_seed = int(inlines.Silk_ADD32_ovflw(int32(s.rand_seed), int32(pulses[pulses_ptr+i])))
...
func (s *SilkNSQState) silk_nsq_scale_states(
	...
	if s.rewhite_flag != 0 {
		...
		for i = s.sLTP_buf_idx - lag - SilkConstants.LTP_ORDER/2; i < s.sLTP_buf_idx; i++ {
			...
			sLTP_Q15[i] = inlines.Silk_SMULWB(inv_gain_Q31, int(sLTP[i]))
		}
	}
	...
	if gain_adj_Q16 != int(int32(1)<<16) {
		...
		for i = s.sLTP_shp_buf_idx - psEncC.ltp_mem_length; i < s.sLTP_shp_buf_idx; i++ {
			s.sLTP_shp_Q14[i] = inlines.Silk_SMULWW(gain_adj_Q16, s.sLTP_shp_Q14[i])
		}
		...
		s.sLF_AR_shp_Q14 = inlines.Silk_SMULWW(gain_adj_Q16, s.sLF_AR_shp_Q14)

		/* Scale short-term prediction and shaping states */
		for i = 0; i < SilkConstants.NSQ_LPC_BUF_LENGTH; i++ {
			s.sLPC_Q14[i] = inlines.Silk_SMULWW(gain_adj_Q16, s.sLPC_Q14[i])
		}
		for i = 0; i < SilkConstants.MAX_SHAPE_LPC_ORDER; i++ {
			s.sAR2_Q14[i] = inlines.Silk_SMULWW(gain_adj_Q16, s.sAR2_Q14[i])
		}
	}
}
...
func (s *SilkNSQState) silk_NSQ_del_dec(
	...
	if psIndices.SignalType == TYPE_VOICED {
		...
		decisionDelay = inlines.Silk_min_int(decisionDelay, lag-LTP_ORDER/2-1)
	}
			...
			if (k & (3 - inlines.Silk_LSHIFT(LSF_interpolation_flag, 1))) == 0 {
				if k == 2 {
					...
					for i = 0; i < decisionDelay; i++ {
						...
						pulses[pulses_ptr+i-decisionDelay] = int8(inlines.Silk_RSHIFT_ROUND(psDD.Q_Q10[last_smple_idx], 10))
						s.xq[pxq+i-decisionDelay] = int16(inlines.Silk_SAT16(inlines.Silk_RSHIFT_ROUND(inlines.Silk_SMULWW(psDD.Xq_Q14[last_smple_idx], Gains_Q16[1]), 14)))
	...
	for i = 0; i < decisionDelay; i++ {
		last_smple_idx = (last_smple_idx - 1) & DECISION_DELAY_MASK
		pulses[pulses_ptr+i-decisionDelay] = int8(inlines.Silk_RSHIFT_ROUND(psDD.Q_Q10[last_smple_idx], 10))
		s.xq[pxq+i-decisionDelay] = int16(inlines.Silk_SAT16(inlines.Silk_RSHIFT_ROUND(inlines.Silk_SMULWW(psDD.Xq_Q14[last_smple_idx], Gain_Q10), 8)))
		s.sLTP_shp_Q14[s.sLTP_shp_buf_idx-decisionDelay+i] = psDD.Shape_Q14[last_smple_idx]
	}
...
func (s *SilkNSQState) silk_noise_shape_quantizer_del_dec(
	...
	smpl_buf_idx *comm.BoxedValueInt,
	decisionDelay int,
) {
	...
	for i = 0; i < length; i++ {
		if signalType == TYPE_VOICED {
			LTP_pred_Q14 = 2
			LTP_pred_Q14 = inlines.Silk_SMLAWB(LTP_pred_Q14, sLTP_Q15[pred_lag_ptr], int(b_Q14[b_Q14_ptr]))
			LTP_pred_Q14 = inlines.Silk_SMLAWB(LTP_pred_Q14, sLTP_Q15[pred_lag_ptr-1], int(b_Q14[b_Q14_ptr+1]))
			LTP_pred_Q14 = inlines.Silk_SMLAWB(LTP_pred_Q14, sLTP_Q15[pred_lag_ptr-2], int(b_Q14[b_Q14_ptr+2]))
			LTP_pred_Q14 = inlines.Silk_SMLAWB(LTP_pred_Q14, sLTP_Q15[pred_lag_ptr-3], int(b_Q14[b_Q14_ptr+3]))
			LTP_pred_Q14 = inlines.Silk_SMLAWB(LTP_pred_Q14, sLTP_Q15[pred_lag_ptr-4], int(b_Q14[b_Q14_ptr+4]))
		...
		if lag > 0 {
			n_LTP_Q14 = inlines.Silk_SMULWB(inlines.Silk_ADD32(s.sLTP_shp_Q14[shp_lag_ptr], s.sLTP_shp_Q14[shp_lag_ptr-2]), HarmShapeFIRPacked_Q14)
			n_LTP_Q14 = inlines.Silk_SMLAWT(n_LTP_Q14, s.sLTP_shp_Q14[shp_lag_ptr-1], HarmShapeFIRPacked_Q14)
		...
		for k = 0; k < nStatesDelayedDecision; k++ {
			...
			LPC_pred_Q14 = inlines.Silk_SMLAWB(LPC_pred_Q14, psDD.sLPC_Q14[psLPC_Q14], int(a_Q12[0]))
			LPC_pred_Q14 = inlines.Silk_SMLAWB(LPC_pred_Q14, psDD.sLPC_Q14[psLPC_Q14-1], int(a_Q12[1]))
			LPC_pred_Q14 = inlines.Silk_SMLAWB(LPC_pred_Q14, psDD.sLPC_Q14[psLPC_Q14-2], int(a_Q12[2]))
			LPC_pred_Q14 = inlines.Silk_SMLAWB(LPC_pred_Q14, psDD.sLPC_Q14[psLPC_Q14-3], int(a_Q12[3]))
			LPC_pred_Q14 = inlines.Silk_SMLAWB(LPC_pred_Q14, psDD.sLPC_Q14[psLPC_Q14-4], int(a_Q12[4]))
			LPC_pred_Q14 = inlines.Silk_SMLAWB(LPC_pred_Q14, psDD.sLPC_Q14[psLPC_Q14-5], int(a_Q12[5]))
			LPC_pred_Q14 = inlines.Silk_SMLAWB(LPC_pred_Q14, psDD.sLPC_Q14[psLPC_Q14-6], int(a_Q12[6]))
			LPC_pred_Q14 = inlines.Silk_SMLAWB(LPC_pred_Q14, psDD.sLPC_Q14[psLPC_Q14-7], int(a_Q12[7]))
			LPC_pred_Q14 = inlines.Silk_SMLAWB(LPC_pred_Q14, psDD.sLPC_Q14[psLPC_Q14-8], int(a_Q12[8]))
			LPC_pred_Q14 = inlines.Silk_SMLAWB(LPC_pred_Q14, psDD.sLPC_Q14[psLPC_Q14-9], int(a_Q12[9]))
			if predictLPCOrder == 16 {
				LPC_pred_Q14 = inlines.Silk_SMLAWB(LPC_pred_Q14, psDD.sLPC_Q14[psLPC_Q14-10], int(a_Q12[10]))
				LPC_pred_Q14 = inlines.Silk_SMLAWB(LPC_pred_Q14, psDD.sLPC_Q14[psLPC_Q14-11], int(a_Q12[11]))
				LPC_pred_Q14 = inlines.Silk_SMLAWB(LPC_pred_Q14, psDD.sLPC_Q14[psLPC_Q14-12], int(a_Q12[12]))
				LPC_pred_Q14 = inlines.Silk_SMLAWB(LPC_pred_Q14, psDD.sLPC_Q14[psLPC_Q14-13], int(a_Q12[13]))
				LPC_pred_Q14 = inlines.Silk_SMLAWB(LPC_pred_Q14, psDD.sLPC_Q14[psLPC_Q14-14], int(a_Q12[14]))
				LPC_pred_Q14 = inlines.Silk_SMLAWB(LPC_pred_Q14, psDD.sLPC_Q14[psLPC_Q14-15], int(a_Q12[15]))
			}
			...
			n_AR_Q14 = inlines.Silk_SMLAWB(n_AR_Q14, tmp2, int(AR_shp_Q13[AR_shp_Q13_ptr]))
			for j = 2; j < shapingLPCOrder; j += 2 {
				tmp2 = inlines.Silk_SMLAWB(psDD.sAR2_Q14[j-1], psDD.sAR2_Q14[j]-tmp1, warping_Q16)
				psDD.sAR2_Q14[j-1] = tmp1
				n_AR_Q14 = inlines.Silk_SMLAWB(n_AR_Q14, tmp1, int(AR_shp_Q13[AR_shp_Q13_ptr+j-1]))
				tmp1 = inlines.Silk_SMLAWB(psDD.sAR2_Q14[j], psDD.sAR2_Q14[j+1]-tmp2, warping_Q16)
				psDD.sAR2_Q14[j] = tmp2
				n_AR_Q14 = inlines.Silk_SMLAWB(n_AR_Q14, tmp2, int(AR_shp_Q13[AR_shp_Q13_ptr+j]))
			}
			psDD.sAR2_Q14[shapingLPCOrder-1] = tmp1
			n_AR_Q14 = inlines.Silk_SMLAWB(n_AR_Q14, tmp1, int(AR_shp_Q13[AR_shp_Q13_ptr+shapingLPCOrder-1]))
			...
			q1_Q0 = inlines.Silk_RSHIFT(q1_Q10, 10)
			if q1_Q0 > 0 {
				q1_Q10 = inlines.Silk_SUB32(inlines.Silk_LSHIFT(q1_Q0, 10), QUANT_LEVEL_ADJUST_Q10)
				q1_Q10 = inlines.Silk_ADD32(q1_Q10, offset_Q10)
				q2_Q10 = inlines.Silk_ADD32(q1_Q10, 1024)
				...
				q1_Q10 = offset_Q10
				q2_Q10 = inlines.Silk_ADD32(q1_Q10, 1024-QUANT_LEVEL_ADJUST_Q10)
				rd1_Q10 = inlines.Silk_SMULBB(q1_Q10, Lambda_Q10)
				rd2_Q10 = inlines.Silk_SMULBB(q2_Q10, Lambda_Q10)
			} else if q1_Q0 == -1 {
				q2_Q10 = offset_Q10
				q1_Q10 = inlines.Silk_SUB32(q2_Q10, 1024-QUANT_LEVEL_ADJUST_Q10)
				rd1_Q10 = inlines.Silk_SMULBB(-q1_Q10, Lambda_Q10)
				rd2_Q10 = inlines.Silk_SMULBB(q2_Q10, Lambda_Q10)
			} else {
				q1_Q10 = inlines.Silk_ADD32(inlines.Silk_LSHIFT(q1_Q0, 10), QUANT_LEVEL_ADJUST_Q10)
				q1_Q10 = inlines.Silk_ADD32(q1_Q10, offset_Q10)
				q2_Q10 = inlines.Silk_ADD32(q1_Q10, 1024)
				rd1_Q10 = inlines.Silk_SMULBB(-q1_Q10, Lambda_Q10)
				rd2_Q10 = inlines.Silk_SMULBB(-q2_Q10, Lambda_Q10)
		...
		for k = 0; k < nStatesDelayedDecision; k++ {
			if psDelDec[k].RandState[last_smple_idx] != Winner_rand_state {
				k2 := k * 2
				sampleStates[k2].RD_Q10 = inlines.Silk_ADD32(sampleStates[k2].RD_Q10, int(2147483647>>4))
				sampleStates[k2+1].RD_Q10 = inlines.Silk_ADD32(sampleStates[k2+1].RD_Q10, int(2147483647>>4))
		...
		if subfr > 0 || i >= decisionDelay {
			pulses[pulses_ptr+i-decisionDelay] = int8(inlines.Silk_RSHIFT_ROUND(psDD.Q_Q10[last_smple_idx], 10))
			xq[xq_ptr+i-decisionDelay] = int16(inlines.Silk_SAT16(inlines.Silk_RSHIFT_ROUND(inlines.Silk_SMULWW(psDD.Xq_Q14[last_smple_idx], delayedGain_Q10[last_smple_idx]), 8)))
		...
		for k = 0; k < nStatesDelayedDecision; k++ {
			...
			psDD.Seed = int(inlines.Silk_ADD32_ovflw(int32(psDD.Seed), int32(inlines.Silk_RSHIFT_ROUND(sampleStates[SS_left].Q_Q10, 10))))
...
func (s *SilkNSQState) silk_nsq_del_dec_scale_states(
	...
	if s.rewhite_flag != 0 {
		...
		for i = s.sLTP_buf_idx - lag - LTP_ORDER/2; i < s.sLTP_buf_idx; i++ {
			inlines.OpusAssert(i < MAX_FRAME_LENGTH)
			sLTP_Q15[i] = inlines.Silk_SMULWB(inv_gain_Q31, int(sLTP[i]))
		}
	}
