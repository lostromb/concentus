...
func silk_find_LPC(
	...
	res_nrg0 := &comm.BoxedValueInt{0}
	res_nrg1 := &comm.BoxedValueInt{0}
	rshift0 := &comm.BoxedValueInt{0}
	rshift1 := &comm.BoxedValueInt{0}
	scratch_box1 := &comm.BoxedValueInt{0}
	scratch_box2 := &comm.BoxedValueInt{0}
