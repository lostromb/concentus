...
func (s *SilkResamplerState) Reset() {
	...
	arrayUtil.MemSetLen(s.sIIR, 0, SilkConstants.SILK_RESAMPLER_MAX_IIR_ORDER)
	arrayUtil.MemSetLen(s.sFIR_i32, 0, SilkConstants.SILK_RESAMPLER_MAX_FIR_ORDER)
	arrayUtil.MemSetLen(s.sFIR_i16, 0, SilkConstants.SILK_RESAMPLER_MAX_FIR_ORDER)
	arrayUtil.MemSetLen(s.delayBuf, 0, 48)
