...
{
    public static class solve_LS
    {
        /* Solves Ax = b, assuming A is symmetric */
        public static void silk_solve_LDL_FIX(
            ...
            )
        {
            ...
            Debug.Assert(M <= SilkConstants.MAX_MATRIX_SIZE);
        ...
        private static void silk_LDL_factorize_FIX(
        ...
        )
        {
            ...
            status = 1;
            diag_min_value = Inlines.silk_max_32(Inlines.silk_SMMUL(Inlines.silk_ADD_SAT32(A[0], A[Inlines.silk_SMULBB(M, M) - 1]), Inlines.SILK_FIX_CONST(TuningParameters.FIND_LTP_COND_FAC, 31)), 1 << 9);
        ...
        private static void silk_LS_divide_Q16_FIX(
        ...
        private static void silk_LS_SolveFirst_FIX(
        ...
        private static void silk_LS_SolveLast_FIX(
        Pointer<int> L_Q16,     /* I    Pointer to Lower Triangular Matrix                          */
        int M,          /* I    Dim of Matrix equation                                      */
        Pointer<int> b,         /* I    b Vector                                                    */
            Pointer<int> x_Q16      /* O    x Vector                                                    */
