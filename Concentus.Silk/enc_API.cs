    ...
    public static class enc_API
    {
        ...
        public static int silk_InitEncoder(silk_encoder encState, int arch, silk_EncControlStruct encStatus)
        {
            ...
            for (int n = 0; n < SilkConstants.ENCODER_NUM_CHANNELS; n++)
            {
                ...
                Debug.Assert(ret == SilkError.SILK_NO_ERROR);
            }
            ...
            int prefillFlag)
        {
            ...
            Debug.Assert(encControl.nChannelsInternal == 1 || psEnc.state_Fxx[0].sCmn.fs_kHz == psEnc.state_Fxx[1].sCmn.fs_kHz);
            ...
            while (true)
            {
                ...
                {
                    Debug.Assert(encControl.nChannelsAPI == 1 && encControl.nChannelsInternal == 1);
                ...
                if (psEnc.state_Fxx[0].sCmn.inputBufIx >= psEnc.state_Fxx[0].sCmn.frame_length)
                {
                    ...
                    Debug.Assert(psEnc.state_Fxx[0].sCmn.inputBufIx == psEnc.state_Fxx[0].sCmn.frame_length);
                    Debug.Assert(encControl.nChannelsInternal == 1 || psEnc.state_Fxx[1].sCmn.inputBufIx == psEnc.state_Fxx[1].sCmn.frame_length);
                    ...
                    HP_variable_cutoff.silk_HP_variable_cutoff(psEnc.state_Fxx);
                    ...
                    for (n = 0; n < encControl.nChannelsInternal; n++)
                    {
                        ...
                        if (channelRate_bps > 0)
                        {
                            ...
                            ret += encode_frame.silk_encode_frame_FIX(psEnc.state_Fxx[n], nBytesOut, psRangeEnc, condCoding, maxBits, useCBR);
                            Debug.Assert(ret == SilkError.SILK_NO_ERROR);
                        }
